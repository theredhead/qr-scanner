...
namespace ScannerZero.iOS.Services;
...
public sealed class IosCameraScanService : NSObject, ICameraScanService, IAVCaptureVideoDataOutputSampleBufferDelegate
{
    ...
    private void Configure()
    {
        ...
        output.SetSampleBufferDelegateQueue(this, new global::Foundation.DispatchQueue("ScannerZero.CameraQueue"));
    ...
    public async void DidOutputSampleBuffer(AVCaptureOutput captureOutput, CoreMedia.CMSampleBuffer sampleBuffer, AVCaptureConnection connection)
    {
        try
        {
            ...
            var result = await BarcodeDecoder.Scan(bitmap).ConfigureAwait(false);
