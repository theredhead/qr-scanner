...
{
    bool TryParse(string raw, out ParsedScanPayload content);
}
...
public static class ScanPayloadStrategies
{
    ...
    public static ParsedScanPayload Analyze(string raw)
    {
        ...
        return new ParsedScanPayload(ContentKind.Text, raw, null, null);
    }
}

public sealed class UrlPayloadStrategy : IScanPayloadStrategy
{
    public bool TryParse(string raw, out ParsedScanPayload content)
    {
        if (Uri.TryCreate(raw, UriKind.Absolute, out var uri) &&
            (uri.Scheme == Uri.UriSchemeHttp || uri.Scheme == Uri.UriSchemeHttps))
        {
            content = new ParsedScanPayload(ContentKind.Url, raw, raw, "Open link");
            return true;
        }
...
public sealed class EmailPayloadStrategy : IScanPayloadStrategy
{
    public bool TryParse(string raw, out ParsedScanPayload content)
    {
        ...
        {
            content = new ParsedScanPayload(ContentKind.Email, raw, raw, "Send email");
            return true;
        }
...
public sealed class PhonePayloadStrategy : IScanPayloadStrategy
{
    public bool TryParse(string raw, out ParsedScanPayload content)
    {
        ...
        {
            content = new ParsedScanPayload(ContentKind.Phone, raw, raw, "Call number");
            return true;
        }
...
public sealed class WifiPayloadStrategy : IScanPayloadStrategy
{
    public bool TryParse(string raw, out ParsedScanPayload content)
    {
        ...
        {
            content = new ParsedScanPayload(ContentKind.WiFi, raw, null, null, TryParseWifi(raw));
            return true;
        }
...
public sealed class VCardPayloadStrategy : IScanPayloadStrategy
{
    public bool TryParse(string raw, out ParsedScanPayload content)
    {
        ...
        {
            content = new ParsedScanPayload(ContentKind.VCard, raw, null, null);
            return true;
        }
...
public sealed class TextPayloadStrategy : IScanPayloadStrategy
{
    public bool TryParse(string raw, out ParsedScanPayload content)
    {
        content = new ParsedScanPayload(ContentKind.Text, raw, null, null);
        return true;
    }
}
