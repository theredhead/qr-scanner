...
public abstract partial class ScanPayloadViewModel : ViewModelBase
{
    ...
    protected ScanPayloadViewModel(string rawText, ParsedScanPayload content, string? imagePath, Action? onDismiss)
    {
        RawText = rawText;
        Content = content;
        ImagePath = imagePath;
    ...
    public ParsedScanPayload Content { get; }
...
public sealed partial class TextPayloadViewModel(string rawText, ParsedScanPayload content, string? imagePath, Action? onDismiss)
    : ScanPayloadViewModel(rawText, content, imagePath, onDismiss);

public sealed partial class UrlPayloadViewModel(string rawText, ParsedScanPayload content, string? imagePath, Action? onDismiss)
    : ScanPayloadViewModel(rawText, content, imagePath, onDismiss)
{
    protected override string CopyStatusMessage => "Link copied.";
}

public sealed partial class EmailPayloadViewModel(string rawText, ParsedScanPayload content, string? imagePath, Action? onDismiss)
    : ScanPayloadViewModel(rawText, content, imagePath, onDismiss)
{
    protected override string CopyStatusMessage => "Email action copied.";
}

public sealed partial class PhonePayloadViewModel(string rawText, ParsedScanPayload content, string? imagePath, Action? onDismiss)
    : ScanPayloadViewModel(rawText, content, imagePath, onDismiss)
{
    protected override string CopyStatusMessage => "Phone action copied.";
}

public sealed partial class VCardPayloadViewModel(string rawText, ParsedScanPayload content, string? imagePath, Action? onDismiss)
    : ScanPayloadViewModel(rawText, content, imagePath, onDismiss)
{
...
public sealed partial class WifiPayloadViewModel(string rawText, ParsedScanPayload content, string? imagePath, Action? onDismiss)
    : ScanPayloadViewModel(rawText, content, imagePath, onDismiss)
{
...
{
    public static ScanPayloadViewModel Create(string rawText, ParsedScanPayload content, string? imagePath, Action? onDismiss) =>
        content.Kind switch
        {
